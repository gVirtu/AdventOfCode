...
while True:
  try:
    ...
    for i in range(int(distance)):
      headCoords = move(headCoords, direction, 1)
      tailCoords = catchUp(headCoords, tailCoords)
      tailCoordSet.add(tailCoords)
